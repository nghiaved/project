                                ...
                                <form>
                                    <div className="row mb-5">
                                        ...
                                        <div className="col-sm-10">
                                            ...
                                            <div className="form-check form-switch">
                                                <input className="form-check-input" type="checkbox" id="flexSwitchCheckdefaultChecked" defaultChecked />
                                                <label className="form-check-label" htmlFor="flexSwitchCheckdefaultChecked">defaultChecked switch checkbox input</label>
                                            </div>
                                            <div className="form-check form-switch">
                                            ...
                                            <div className="form-check form-switch">
                                                <input className="form-check-input" type="checkbox" id="flexSwitchCheckdefaultCheckedDisabled" defaultChecked disabled />
                                                <label className="form-check-label" htmlFor="flexSwitchCheckdefaultCheckedDisabled">Disabled defaultChecked switch checkbox input</label>
                                            </div>
                                        </div>
                                    </div>
